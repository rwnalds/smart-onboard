...
import { 
  Settings, Play, Save, Users, Copy, Check, ExternalLink, 
  ChevronDown, ChevronUp, LogOut, LayoutDashboard, MessageSquare, 
  BarChart3, Sparkles, Palette, Sliders, Hash
} from 'lucide-react';
...
const AdminDashboard: React.FC<Props> = ({ user, config, onSave, onStart, onLogout }) => {
  ...
  const handleThemeChange = (key: keyof AgencyConfig['theme'], value: string) => {
    setFormData(prev => ({
        ...prev,
  ...
  const recentSubmissions = submissions.filter(s => (Date.now() - s.timestamp) < 7 * 24 * 60 * 60 * 1000).length;
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-8">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-xl tracking-tight text-slate-800">SmartOnboard</span>
              </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div className="mb-8">
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight">
                {activeTab === 'config' ? 'Agent Configuration' : 'Client Submissions'}
            </h1>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                />
                                <p className="mt-1 text-xs text-slate-400">What does your agency do? The AI uses this to introduce your services.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 space-y-6">
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 mb-1">Ideal Client Profile</label>
                                    <input
                                        type="text"
                                        name="targetAudience"
                                        ...
                                        className="w-full bg-white rounded-lg border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors py-2 px-3 border outline-none"
                                    />
                                    <p className="mt-1 text-xs text-slate-400">Helps AI contextualize the questions.</p>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 mb-1">Max Questions</label>
                                    <div className="relative">
                                    ...
                                    <p className="mt-1 text-xs text-slate-400">Prevent the form from becoming too long.</p>
                                </div>
                             </div>

                             <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Onboarding Goal ("Definition of Done")</label>
                                <textarea
                                    name="onboardingGoal"
                                    rows={3}
                                    ...
                                    className="w-full bg-white rounded-lg border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors py-2 px-3 border outline-none resize-none"
                                />
                                <p className="mt-1 text-xs text-slate-400">The specific information the AI must gather before finishing.</p>
                            </div>
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                             <div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <span className="text-sm font-mono text-slate-500 uppercase">{formData.theme?.primaryColor}</span>
                                </div>
                                <p className="mt-1 text-xs text-slate-400">Buttons & Progress Bar</p>
                             </div>
                             ...
                             <div>
                                ...
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        className="h-10 w-10 p-1 rounded border border-slate-200 cursor-pointer bg-white"
                                    />
                                    <span className="text-sm font-mono text-slate-500 uppercase">{formData.theme?.backgroundColor}</span>
                                </div>
                                <p className="mt-1 text-xs text-slate-400">Form Page Background</p>
                             </div>
                             ...
                             <div>
                                ...
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        className="h-10 w-10 p-1 rounded border border-slate-200 cursor-pointer bg-white"
                                    />
                                    <span className="text-sm font-mono text-slate-500 uppercase">{formData.theme?.textColor}</span>
                                </div>
                                <p className="mt-1 text-xs text-slate-400">Main Font Color</p>
                             </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                     <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-lg p-6 text-white sticky top-28">
                        ...
                        <p className="text-indigo-100 text-sm mb-6">
                            Save your configuration and preview the onboarding flow as if you were a client.
                        </p>
                     ...
                     <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                        ...
                        <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 flex items-center justify-between gap-2">
                            ...
                            <button onClick={copyLink} className="p-1.5 hover:bg-white rounded-md shadow-sm transition-all text-slate-500">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-bold text-slate-900">{recentSubmissions}</p>
                        </div>
                    </div>
                     <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-4">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden min-h-[400px]">
                    {submissions.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center py-20">
                            ...
                            <h3 className="text-slate-900 font-medium mb-1">No responses yet</h3>
                            <p className="text-slate-500 text-sm">Share your link to start collecting onboarding data.</p>
                        </div>
                    ) : (
                        <div className="divide-y divide-slate-100">
                             {submissions.map((sub) => {
                                 ...
                                 return (
                                    <div key={sub.id} className="transition-colors hover:bg-slate-50">
                                        <div 
                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h4 className="text-sm font-semibold text-slate-900">{sub.clientName}</h4>
                                                    <p className="text-xs text-slate-500">{new Date(sub.timestamp).toLocaleDateString()} at {new Date(sub.timestamp).toLocaleTimeString()}</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-3">
                                            ...
                                            <div className="px-6 pb-6 pt-2 bg-slate-50/50 border-t border-slate-100">
                                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                                    ...
                                                    <div className="lg:col-span-1">
                                                        <div className="bg-white p-4 rounded-xl border border-indigo-100 shadow-sm">
                                                            <div className="flex items-center gap-2 mb-3">
                                                                ...
                                                                <h5 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Executive Summary</h5>
                                                            </div>
                                                    ...
                                                    <div className="lg:col-span-2 space-y-4">
                                                        <h5 className="text-xs font-bold text-slate-400 uppercase tracking-wider pl-2">Full Transcript</h5>
                                                        {sub.answers.map((ans, idx) => (
                                                            <div key={idx} className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm relative group hover:border-indigo-200 transition-colors">
                                                                <div className="absolute left-0 top-4 bottom-4 w-1 bg-slate-200 rounded-r group-hover:bg-indigo-400 transition-colors"></div>
                                                                <p className="text-xs font-medium text-slate-500 mb-1 ml-2 uppercase tracking-wide">Q{idx + 1}: {ans.questionText}</p>
